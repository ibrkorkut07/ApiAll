...
public class Get07Solution extends JsonplaceholderBaseUrl {
    	/*
		     				Warm Up (13 minutes)
    ...
    */
    @Test
    public void api1(){
       Response response = given().spec(specJson).when().get();
       response.prettyPrint();
       response.then().
               assertThat().
               statusCode(200).contentType("text/html; charset=UTF-8").body("id", Matchers.hasSize(200),
