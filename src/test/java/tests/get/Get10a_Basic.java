...
public class Get10a_Basic extends DummyBaseUrl {
    ...
    */
    ...
    // DE-SERIALIZATION
    @Test
    public void test10_Deserialization() {
        specDummy.pathParams("1", "api", "2", "v1", "3", "employees");
    ...
    public void test06_ObjectMapper() {
        ...
        // System.out.println("10th employee's id = " + ((Map) ((List) actJavaData.get("data")).get(10)).get("id")   );

        assertEquals(expJavaData.get("id"), ((Map) ((List) actJavaData.get("data")).get(10)).get("id"));
        assertEquals(expJavaData.get("employee_name"), ((Map) ((List) actJavaData.get("data")).get(10)).get("employee_name"));
        assertEquals(expJavaData.get("employee_salary"), ((Map) ((List) actJavaData.get("data")).get(10)).get("employee_salary"));
        assertEquals(expJavaData.get("employee_age"), ((Map) ((List) actJavaData.get("data")).get(10)).get("employee_age"));
        assertEquals(expJavaData.get("profile_image"), ((Map) ((List) actJavaData.get("data")).get(10)).get("profile_image"));
