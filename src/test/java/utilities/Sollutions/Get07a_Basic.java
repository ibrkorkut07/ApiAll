...
public class Get07a_Basic extends JsonplaceholderBaseUrl {
    /*
    ...
    */
    ...
    // DE-SERIALIZATION
    @Test
    public void test07_Deserialization() {
        specJson.pathParam("1", "todos");
        Response response = given().spec(specJson).when().get("{1}");
    /*
        When I send a GET Request to
    ...
    */
    ...
    // OBJECT MAPPER
    @Test
    public void test07_ObjectMapper() {
            /*
        When I send a GET Request to
             https://jsonplaceholder.typicode.com/todos
		Then
